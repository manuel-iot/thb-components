///
/// Copyright © 2016-202additionalActionsColumn The Thingsboard Authors
///
...
import { AttributeScope, DataKeyType, PageComponent, widgetType } from "@shared/public-api";
...
import { catchError, debounceTime, distinctUntilChanged, map, skip, startWith, take, takeUntil } from 'rxjs/operators';
import { MatPaginator } from '@angular/material/paginator';
import { MatSort } from '@angular/material/sort';
import { DomSanitizer, SafeHtml } from '@angular/platform-browser';

import { Overlay, OverlayConfig, OverlayRef } from '@angular/cdk/overlay';
import { SubscriptionEntityInfo, WidgetSubscriptionOptions } from '@core/api/widget-api.models';
...
import { DEFAULT_OVERLAY_POSITIONS } from "@shared/public-api";
import { DateFormatSettings } from '@shared/public-api';
import { UtilsService } from '@core/public-api';
import { CellContentInfo, CellStyleInfo, DisplayColumn, RowStyleInfo, TableCellButtonActionDescriptor, TableWidgetDataKeySettings, TableWidgetSettings, checkHasActions, constructTableCssString, getCellContentInfo, getCellStyleInfo, getColumnDefaultVisibility, getColumnSelectionAvailability, getRowStyleInfo, getTableCellButtonActions, noDataMessage, prepareTableCellButtonActions } from './table-widget.models';
...
@Component({
  selector: 'dynamic-timeseries-table',
  templateUrl: './dynamic-timeseries-table.component.html',
  styleUrls: ['./dynamic-timeseries-table.component.scss', './table-widget.scss']
})
export class DynamicTimeseriesTableComponent extends PageComponent implements OnInit, AfterViewInit, OnDestroy {
