...
import {
  ...
  measureAxisNameSize
} from './echarts-widget.models';
import { DateFormatProcessor, ValueSourceType } from '@shared/public-api';
import {
...
import { DataKey, Datasource, DatasourceType, FormattedData, widgetType } from '@shared/public-api';
...
import { BarRenderSharedContext } from './time-series-chart-bar.models';
import { TimeSeriesChartStateValueConverter } from './time-series-chart-state.models'; 
import { ChartLabelPosition, ChartShape, toAnimationOption } from './chart.models';
import {
...
} from './time-series-chart-tooltip.models';
...
export class TbTimeSeriesChart {
  ...
  constructor(private ctx: WidgetContext,
              ...
              private readonly inputSettings: TimeSeriesChartSettings,
