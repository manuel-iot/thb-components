...
import {
  ...
  import { backgroundStyle, ComponentStyle, overlayStyle, textStyle } from '@shared/public-api'

  import { ImagePipe } from '@shared/public-api';
  import { DomSanitizer } from '@angular/platform-browser';
  import { LegendConfig, LegendData, LegendKey, LegendPosition } from '@shared/public-api'
  import { TbTimeSeriesChart } from './time-series-chart';
  import {
    timeSeriesChartWidgetDefaultSettings,
    TimeSeriesChartWidgetSettings
  } from './time-series-chart-widget.models';
  ...
  export class OneDynamicChartWidgetComponent implements OnInit, OnDestroy, AfterViewInit {
