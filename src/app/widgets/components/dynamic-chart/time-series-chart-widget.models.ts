...
import {
  ...
  import { BackgroundSettings, BackgroundType, Font } from '@shared/public-api';
  import { defaultLegendConfig, LegendConfig, LegendPosition, widgetType } from '@shared/public-api';
